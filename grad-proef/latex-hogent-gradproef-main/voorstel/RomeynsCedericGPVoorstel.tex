...
%   zelf
%
\specialisation{Game Development \& Networking}
\keywords{Scheme, World Wide Web, $\lambda$-calculus}

\begin{document}

\begin{abstract}  
  Dit onderzoek richt zich op de ontwikkeling van een multiplayer platformgame in GameMaker Studio 2 met Gamemaker Language (GML). De focus ligt op het ontwerpen van soepele parkour-mechanieken en efficiënte netwerkfunctionaliteit binnen een GameMaker-omgeving. En het leren werken met GML een taal die wat lijkt op javascript.
